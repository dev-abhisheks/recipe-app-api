...
class PublicRecipeAPITests(TestCase):
    ...
    def test_auth_required(self):
        """Test auth is required ti call API."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        original_link = 'http://example.recipe.pdf'
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Masala Soda')
        r2 = create_recipe(user=self.user, title='Panipuri')
        tag1 = Tag.objects.create(user=self.user, name='Salt')
        tag2 = Tag.objects.create(user=self.user, name='Water')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Masala Puri')
    ...
    def test_filter_by_ingredients(self):
        """Test filtering recipes bt ingredients."""
        r1 = create_recipe(user=self.user, title='Mango Juice')
        r2 = create_recipe(user=self.user, title='Apple Juice')
        ing1 = Ingredient.objects.create(user=self.user, name='mango')
        ing2 = Ingredient.objects.create(user=self.user, name='apple')
        r1.ingredients.add(ing1)
        r2.ingredients.add(ing2)
        r3 = create_recipe(user=self.user, title='Banana Juice')
